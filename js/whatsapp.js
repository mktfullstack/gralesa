...
$form.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let message = 'send?phone=' + phone + '&text=%0A*Hola, mi nombre es:*%0A' + name + '%0A*Escribo desde:*%0A' + lastname + '%0A*Me gustaría saber la siguiente información:*%0A' + email + ''
